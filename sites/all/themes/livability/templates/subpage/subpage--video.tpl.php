...
<div id="page-<?php print $node->type; ?>" class="main-container <?php print $container_class; ?>">
  ...
  <section id="page-<?php print $node->nid; ?>" class="<?php print $node->type; ?> <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class="col-md-12 state-menu">
      <?php if (!empty($breadcrumb)): print $breadcrumb; endif;?>
      <div class="col-md-5">
        <?php print render($title_prefix); ?>
        <?php if (!empty($title)): ?>
          <span class="livicon"></span>
          <h1 class="page-title white">Best Places to Live <?php print $title; ?></h1>
      ...
      <div class="col-md-7 statenav">
        <?php if (!empty($page['liv_state_nav'])){ ?>
          <?php print render($page['liv_state_nav']); ?>
        <?php } else { ?>
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#statenavbar">
            <span class="sr-only"><?php print t('Toggle navigation'); ?></span>
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
          </button>
          <div class="navbar-collapse collapse" id="statenavbar">
            <ul class="menu nav">
              <?php if (!empty($page['liv_state_1']['views_state-block_4'])){ ?>
              ...
              <?php if (!empty($page['liv_state_1']['views_state-block_5'])){ ?>
