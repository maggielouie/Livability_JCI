      ...
      <?php if (isset($cityname)) { ?>
        <span class="city-pin">
          <a href="<?php print $cityurl; ?>">
            ...
            <h2><?php print $cityname; ?><?php if (!empty($state)) { ?>, <strong class="green"><?php print $state; ?></strong><?php } ?></h2>
          </a>
          <span class="county-area no-mobile">
          <?php if (!empty($countyname)) {
            echo "<a href=" . $countyurl . ">" . $countyname . "</a>";
          }
            if (!empty($countyname && $metroname)) echo ', ' ;?><?php if ($metroname) echo $metroname .' Metro Area'; ?></span>
