      ...
      <div id="content-header">
        ...
        <?php if(array_key_exists('special_header',$page)){
          ...
          <span class="best-pin">
				...
				<h1><?php print $page_title ? $page_title : $title; ?></h1>
        <span class="county-area no-mobile">
          <?php if ($category): ?>
            Explore our <?php print $category; ?> Top 10 Lists.
            <?php else: ?>
            Explore our lists of the Top 10 best places for everything from college towns to foodie cities.
          <?php endif; ?>
        </span>
			</span>
        <?php } ?>
